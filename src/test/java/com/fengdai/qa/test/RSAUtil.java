...
//    public static final String PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDYzEkQRJEA2RGBVVjdP6PDIA5j0JR9RwHCZo6cLB+gfQyPq+RiWPYUfFdnB/Nkn5VtoLDGnytk7Sw6VtQKrGDQhlbGNcn6C+EOcf2KxOJg/8bD8GiFXtRRZmb9pL7P04gn6vnHkJmgigFzhee0lj9MgzZknUx4xd6OquZ4DxbG2wIDAQAB";
   ...
   public static final String PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDGTvxYdsU2eufB/VohEb9DJKjvjZrWC+x9I9H8\n" +

            "T2SCJC48x2RU1qU/8rNK2MdFqaBGhGBguhAvHY6tSSeuKBY2PhEm89pii8/WAw4rxG7YMgv9VaUGEEcXoo0qWtImwzxPU0Fq3sVAk8uycAPS8ecTW2mcafUSqIa5HTaR0aZvpwIDAQAB";
...
//        String mim = "zuI1ZtHMKo5HeJOTSWMk5Be5g5SFx8fNBXNPKvl7FdHNUH+L

// /bwpMf7HSfZmtW2SsIgtu+fhS76Av1/78h27sJVgx/n8w7QbWUElUU8FT06Q/n+K9fTLefDS6AqeB8+fmLgGU81+bbapFA40exIDnb8arT+MEJYASWfEi/S91i8=";
...
//        System.out.println(MD5Util.getMD5Code(decryptByPrivateKey(mim, privateKey)));
        ...
        String ming51 = "51@gongjijing32!1_" + nowtime + "_15004591802";

        String mi51 = encryptByPublicKey(ming51, PUBLIC_KEY_TR).replaceAll("\r\n", "");

        System.out.println(mi51);

        System.out.println("{\"timestamp\":\"" + nowtime + "\",\"mobilePhone\":\"15004591802\",\"userSource\":\"" + mi51 + "\"}");
...
//       String login1 =  "{ 'mobilePhone':'15004591802', 'userSource':'QD000015', 'password':'123456' }";
